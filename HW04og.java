...
public class HW04og {
   ...
   */
  public static Geyserog read(Scanner sc) {
    Geyserog g = new Geyserog();
   ...
   */
  public static void simDay(int d, Geyserog[] G, Random r) {
    int k = 0;
